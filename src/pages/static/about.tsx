      ...
      <div className="mx-64 mt-4">
        ...
        <div className="flex flex-row items-start justify-evenly">
          ...
          <div className="w-1/2">
            ...
            <p className="mb-2 font-serif text-xl">
              Become a part of [Your Platform Name] today and immerse yourself in a community that celebrates the love
              of books.
            </p>
            <p className="font-serif text-xl">
              Together, let&apos;s build a place where stories are shared, connections are made, and the love for
              reading thrives.
            </p>
          </div>
        </div>
        <div>
          ...
          <div className="flex flex-row items-center justify-between gap-8">
            ...
            <div className="flex flex-col items-center">
              ...
              <p className="text-md text-center font-serif text-gray-500">
                Find new homes for your books and discover hidden gems from other readers. Our marketplace is designed
                to make buying and selling books easy, secure, and enjoyable.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="choose-container flex flex-row justify-between gap-16 text-center">
            ...
            <div className="mt-24 w-full pl-32 text-left">
              ...
              <p className="text-md ml-6 font-serif">
                Our platform is designed to be intuitive and easy to use, ensuring a smooth experience whether
                you&apos;re socializing, exchanging, buying, or selling.
              </p>
            </div>
          </div>
        </div>
