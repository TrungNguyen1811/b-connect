  ...
  return (
    <div className="mx-64 mt-4">
      ...
      <div className="flex flex-row items-start justify-evenly">
        ...
        <img
          className="h-[75%] w-1/2"
          src="https://res.cloudinary.com/dbpvdxzvi/image/upload/v1716459293/Books/Image/cnaqrji6fal5x4b2rzqj.png"
          alt="image"
        />
      </div>
      <div className="flex flex-row items-start justify-evenly">
        <img
          className="w-1/2"
          src="https://res.cloudinary.com/dbpvdxzvi/image/upload/v1716459291/Books/Image/mk7oblilkwwbk8rmv6ig.png"
          alt="image"
        />
        <div className="w-1/2">
          <p className="mb-4 mt-16 text-3xl font-bold">Join Us</p>
          <p className="mb-2 font-serif text-xl">
            Become a part of BConnect today and immerse yourself in a community that celebrates the love of books.
          </p>
          <p className="font-serif text-xl">
      ...
      <div>
        ...
        <div className="flex flex-row items-center justify-between gap-8">
          <div className="flex flex-col items-center">
            ...
            <img
              className="h-72"
              src="https://res.cloudinary.com/dbpvdxzvi/image/upload/v1716453865/Books/Image/brdxqcgqh1jjzathqvhv.png"
              alt="image"
            />
          ...
          <div className="flex flex-col items-center">
            ...
            <img
              className="h-72"
              src="https://res.cloudinary.com/dbpvdxzvi/image/upload/v1716459288/Books/Image/cwefwppl1qjaboprlam9.png"
              alt="image"
            />
            <p className="text-md text-center font-serif text-gray-500">
          ...
          <div className="flex flex-col items-center">
            ...
            <img
              className="h-72"
              src="https://res.cloudinary.com/dbpvdxzvi/image/upload/v1716453864/Books/Image/qq5httsb5oocf36mjdfc.png"
              alt="image"
            />
            <p className="text-md text-center font-serif text-gray-500">
