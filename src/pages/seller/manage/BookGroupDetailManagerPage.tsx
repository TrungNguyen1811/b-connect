...
function BookGroupDetailManagerPage() {
  ...
  const title = `Manage Book of Group`
  const description = 'Manage Book of Group (Server side table functionalities.)'
  ...
  return (
    <div className="mx-4">
      <MetaData title={'Manage Book of Group'} />
      ...
      <BookGroupDetailTable />
    </div>
  )
}

export default BookGroupDetailManagerPage
