...
import { getAllTransactionByUser } from 'src/api/transaction/get-transaction'

export function useTransactionTable(columns: ColumnDef<ITransaction>[]) {
  ...
  const queryController = useQuery<IResponse<ITransaction[]>, AxiosError>(
    [...API_GET_ALL_USER_QUERY_KEYS, queries],
    () => getAllTransactionByUser(queries),
    {
