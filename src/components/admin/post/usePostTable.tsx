...
import { getAllPosts } from 'src/api/blog/get-blog'

export function usePostTable(columns: ColumnDef<IResponsePost>[]) {
  ...
  const queryController = useQuery<IResponse<IResponsePost[]>, AxiosError>(
  ...
  const table = useReactTable<IResponsePost>({
    columns,
